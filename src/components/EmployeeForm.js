...
// //         " http://localhost:5000/api/employees/api/employees"
// //       );
...
// //             ` http://localhost:5000/api/employees/api/employees/${selectedEmployeeId}`,
// //             formData
// //           );
...
// //             "http://localhost:5000/api/employees/api/employees/api/employees",
// //             formData
// //           );
...
// //       try {
// //         await axios.delete(`http://localhost:5000/api/employees/api/employees/api/employees/${id}`);
...
//   const fetchEmployees = async () => {
//     try {
//       const response = await axios.get("http://localhost:5000/api/employees/api/employees");
//       setEmployees(response.data);
//     } catch (error) {
//       console.error("Error fetching employees", error);
//     }
...
//     if (window.confirm("Are you sure you want to delete this employee?")) {
//       try {
//         await axios.delete(`http://localhost:5000/api/employees/api/employees/`);
//         alert("Employee deleted successfully");
//         setEmployees((prevEmployees) =>
//           prevEmployees.filter((employee) => employee.employeeId !== id)
//         );
...
//     if (
//       !formData.employeeId ||
//       !/^[a-zA-Z0-9]{1,10}$/.test(formData.employeeId)
//     ) {
//       formErrors.employeeId =
//         "Employee ID is required, must be alphanumeric, and cannot exceed 10 characters";
//       valid = false;
